...
bucket_name="s3-event-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="harshithreddyalakanti15@gmail.com"
...
aws sns publish \
  ...
  --message "Hello This is harshith reddy, this is a demo project for se event triggering"
